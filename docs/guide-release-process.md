...
Once the release is published, [Validate DotSlash Artifacts](https://github.com/facebook/react-native/actions/workflows/validate-dotslash-artifacts.yml) will validate that these assets were uploaded correctly. Ensure that this actions is green and that the assets exist on the release:
