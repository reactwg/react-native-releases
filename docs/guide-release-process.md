...
* ⌛ Create GitHub release + Verify DevTools release artifacts → https://github.com/facebook/react-native/releases/tag/v0.78.0-rc.0
...
### Step 8: Create the GitHub Release + Verify 
...
- After publishing the draft, verify it includes the following 5 DevTools release artifacts at `https://github.com/facebook/react-native/releases/download/v0.82.0-rc.3/`:
  - React.Native.DevTools-linux-aarch64.tar.gz
  - React.Native.DevTools-linux-x86_64.tar.gz
  - React.Native.DevTools-macos-aarch64.tar.gz
  - React.Native.DevTools-macos-x86_64.tar.gz
  - React.Native.DevTools-windows-x86_64.tar.gz
